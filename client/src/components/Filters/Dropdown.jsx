...
const Dropdown = ( {handleFilterOrder}) => {
  ...
  return (
    <div className="font-general-sans w-[auto]">
      <button
        id="dropdownBgHoverButton"
        onClick={toggleDropdown}
        data-dropdown-toggle="dropdownBgHover"
        className="w-[200px] text-gray-600 bg-gray-200 hover:bg-black hover:text-white focus:ring-none focus:outline-none focus:ring-none font-medium rounded-lg text-sm px-5 py-2.5 text-center flex justify-between items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button"
      >
        Order by {" "}
        <svg
